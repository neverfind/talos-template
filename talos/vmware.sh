...
export GOVC_USERNAME='user-1'
export GOVC_PASSWORD='123password'
export GOVC_INSECURE=true
export GOVC_URL='https://url.com'
export GOVC_DATASTORE='vsanDatastore'
#export GOVC_RESOURCE_POOL='K8S' ## Optional.

CLUSTER_NAME=${CLUSTER_NAME:=k8s-vsphere}
